...
class TypeEngine(Visitable):
    ...
    class Comparator(operators.ColumnOperators):
        ...
        @util.dependencies("sqlalchemy_1_3.sql.default_comparator")
    ...
    @util.dependencies("sqlalchemy_1_3.engine.default")
    def _default_dialect(self, default):
        if self.__class__.__module__.startswith("sqlalchemy_1_3.dialects"):
