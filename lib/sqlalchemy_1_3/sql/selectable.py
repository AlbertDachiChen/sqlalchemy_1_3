...
from sqlalchemy_1_3.sql.visitors import Visitable
...
class FromClause(Selectable):
    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    @util.dependencies("sqlalchemy_1_3.sql.functions")
    ...
    @util.dependencies("sqlalchemy_1_3.sql.util")
...
class CTE(Generative, HasPrefixes, HasSuffixes, Alias):
    ...
    @util.dependencies("sqlalchemy_1_3.sql.dml")
