...
class ColumnDefault(DefaultGenerator):
    ...
    @util.memoized_property
    @util.dependencies("sqlalchemy_1_3.sql.sqltypes")
...
class Sequence(IdentityOptions, DefaultGenerator):
    ...
    @util.dependencies("sqlalchemy_1_3.sql.functions.func")
...
class MetaData(SchemaItem):
    ...
    @util.dependencies("sqlalchemy_1_3.engine.url")
    def _bind_to(self, url, bind):
        """Bind this MetaData to an Engine, Connection, string or URL."""

        if isinstance(bind, util.string_types + (url.URL,)):
            self._bind = sqlalchemy_1_3.create_engine(bind)
        else:
            self._bind = bind
    ...
    def _bind_to(self, url, bind):
        ...
        if isinstance(bind, util.string_types + (url.URL,)):
            try:
                ...
                e = sqlalchemy_1_3.create_engine(bind)
