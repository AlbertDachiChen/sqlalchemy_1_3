...
def pytest_addoption(parser):
    group = parser.getgroup("sqlalchemy_1_3")
...
def pytest_configure(config):
    pytest.register_assert_rewrite("sqlalchemy_1_3.testing.assertions")
...
def _pytest_fn_decorator(target):
    ...
    from sqlalchemy_1_3.util.langhelpers import format_argspec_plus
