...
def post_begin():
    ...
    from sqlalchemy_1_3 import testing  # noqa
    from sqlalchemy_1_3.testing import fixtures, engines, exclusions  # noqa
    from sqlalchemy_1_3.testing import assertions, warnings, profiling  # noqa
    from sqlalchemy_1_3.testing import config  # noqa
    from sqlalchemy_1_3 import util  # noqa
...
def _prep_testing_database(options, file_config):
    from sqlalchemy_1_3.testing import config, util
    from sqlalchemy_1_3.testing.exclusions import against
    from sqlalchemy_1_3 import schema, inspect
...
def _reverse_topological(options, file_config):
    if options.reversetop:
        from sqlalchemy_1_3.orm.util import randomize_unitofwork
